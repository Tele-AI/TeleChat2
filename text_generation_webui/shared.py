...
settings = {
    ...
    # 'chat_template_str': "<_start>{%- for message in messages %}{% if message.role == 'user' %}{{'<_user>'+message.content}}{% endif %}{% if message.role == 'bot' %}{{'<_bot>'+message.content+'<_end>'}}{% endif %}{% endfor %}{% if add_generation_prompt %}<_bot>{% endif %}",
