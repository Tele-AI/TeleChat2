...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.TOKEN_EMBD: (
            ...
            "transformer.word_embeddings",               # falcon telechat2
        ...
        MODEL_TENSOR.OUTPUT: (
            "embed_out",                 # gptneox
            "lm_head",                   # gpt2 mpt falcon llama-hf baichuan qwen mamba dbrx jais nemotron exaone olmoe olmo2 telechat2
        ...
        MODEL_TENSOR.OUTPUT_NORM: (
            ...
            "transformer.ln_f",                        # gpt2 gpt-j falcon jais exaone telechat2
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_NORM: (
            ...
            "transformer.h.{bid}.input_layernorm",                  # falcon7b telechat2
        ...
        MODEL_TENSOR.ATTN_Q: (
            ...
            "transformer.h.{bid}.self_attention.query",                  # telechat2
        ...
        MODEL_TENSOR.ATTN_OUT: (
            ...
            "transformer.h.{bid}.self_attention.dense",                     # falcon telechat2
        ...
        MODEL_TENSOR.ATTN_POST_NORM: (
            ...
            "transformer.h.{bid}.post_attention_layernorm",     # telechat2
        ),
        ...
        MODEL_TENSOR.FFN_UP: (
            ...
            "transformer.h.{bid}.mlp.up_proj",                        # telechat2
        ...
        MODEL_TENSOR.FFN_GATE: (
            ...
            "transformer.h.{bid}.mlp.gate_proj",          # telechat2
        ...
        MODEL_TENSOR.FFN_DOWN: (
            ...
            "transformer.h.{bid}.mlp.down_proj",                      # telechat2
